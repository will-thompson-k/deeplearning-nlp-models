...
class MultiHeadedAttention(nn.Module):
    ...
    def forward(self, query, key, value, mask):
        ...
        # 1) Apply linear to query, key, and value, convert to 4D matrix
        # (batch_size,dim_keys) -> (batch_size, num_heads,max_seq_length, dim_keys)
        ...
        x = x.transpose(1, 2).view(batch_size, max_seq_length, self._num_heads * self._dim_keys)
